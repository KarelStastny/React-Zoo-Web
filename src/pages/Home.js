  ...
  return  <div className='home-page'>
    ...
    <div className="home-conatainer">
      ...
      <section>
        ...
        <div style={{backgroundColor:"rgb(136, 119, 101)"}} className="right">
          <h2>Zvířata v Zoo</h2>
      ...
      <section>
        ...
        <div style={{backgroundColor:"rgb(243, 237, 231)"}} className="right">
      ...
      <section>
        ...
        <div style={{backgroundColor:"rgb(165, 196, 216)"}}  className="right">
      ...
      <section>
        ...
        <div  style={{backgroundColor:"rgb(35, 35, 36)"}} className="right">
      ...
      <section>
        ...
        <div style={{backgroundColor:"rgb(177, 140, 40)"}}   className="right">
      ...
      <section>
        ...
        <div style={{backgroundColor:"rgb(16, 100, 37)"}}   className="right">
