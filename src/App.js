...
const App = () => {
  return <div className="app">
    ...
    Magnam corporis mollitia nostrum amet? Dicta, optio! Repudiandae eius ducimus quo accusamus earum fuga quibusdam quisquam at blanditiis natus consectetur, perferendis, amet eaque adipisci temporibus fugit animi iusto, necessitatibus atque.
    Ex labore, inventore deleniti laudantium quibusdam autem? Accusantium perspiciatis quam nisi expedita aliquam quo fugit id blanditiis soluta, rem nobis maiores ea similique. Debitis dignissimos temporibus quasi eveniet! Nobis, ullam.
